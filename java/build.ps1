...
$(& antlr4 -package it.univr.injectiontool.java -visitor -v $version JavaLexer.g4 -encoding utf-8 -Dlanguage=Java   ; $compile_exit_code = $LASTEXITCODE) | Write-Host
if($compile_exit_code -ne 0){
    exit $compile_exit_code
}
$(& antlr4 -package it.univr.injectiontool.java -visitor -v $version JavaParser.g4 -encoding utf-8 -Dlanguage=Java   ; $compile_exit_code = $LASTEXITCODE) | Write-Host
if($compile_exit_code -ne 0){
    exit $compile_exit_code
}
