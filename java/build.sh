...
antlr4 -package it.univr.injectiontool.java -visitor -v $version -encoding utf-8 -Dlanguage=Java   JavaLexer.g4
antlr4 -package it.univr.injectiontool.java -visitor -v $version -encoding utf-8 -Dlanguage=Java   JavaParser.g4
