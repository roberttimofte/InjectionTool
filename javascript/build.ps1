...
$(& antlr4 -package it.univr.injectiontool.javascript -visitor -v $version JavaScriptLexer.g4 -encoding utf-8 -Dlanguage=Java   ; $compile_exit_code = $LASTEXITCODE) | Write-Host
if($compile_exit_code -ne 0){
    exit $compile_exit_code
}
$(& antlr4 -package it.univr.injectiontool.javascript -visitor -v $version JavaScriptParser.g4 -encoding utf-8 -Dlanguage=Java   ; $compile_exit_code = $LASTEXITCODE) | Write-Host
if($compile_exit_code -ne 0){
    exit $compile_exit_code
}
